...
class DataSource {
    ...
    func getSectionInfoAtIndexPath(_ indexPath: IndexPath) -> Section? {
        
        guard let sectionTitle = titleForSectionAtIndexPath(indexPath) else {
            print("section title is not available")
            return nil
        }
        
        let sectionCount = numberOfParksInSection(indexPath.section)
        let sectionImageName = sectionTitle
        
        return Section(sectionTitle: sectionTitle, sectionCount: sectionCount, sectionImageName: sectionImageName)
    }
	...
	private func titleForSectionAtIndexPath(_ indexPath: IndexPath) -> String? {
